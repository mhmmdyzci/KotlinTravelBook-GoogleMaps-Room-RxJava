...
import com.mhmmdyzci.kotlinmaps.adapter.PlaceAdapter
import com.mhmmdyzci.kotlinmaps.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleResponse(placeList: List<Place>){
        ...
        var placeAdapter = PlaceAdapter(placeList)
